# Awesome-Video-Robotic-Papers with stars
...
* **Let Me Help You! Neuro-Symbolic Short-Context Action Anticipation**
  * [Code](https://github.com/sarthak268/nesca-pytorch) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2024-11-27
...
* **Generalization with Lossy Affordances: Leveraging Broad Offline Data for Learning Visuomotor Tasks**
  * [Code](https://github.com/kuanfang/flap) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2022-12-16
...
* **VIP: Towards Universal Visual Reward and Representation via Value-Implicit Pre-Training**
  * [Code](https://github.com/facebookresearch/vip) ⚠️ Archived
...
* **Octo: An Open-Source Generalist Robot Policy**
  * [Code](https://github.com/octo-models/octo) ⭐ 1,735 | 🐛 96 | 🌐 Python | 📅 2024-07-31
...
* **HRP: Human Affordances for Robotic Pre-Training**
  * [Code](https://github.com/SudeepDasari/data4robotics/tree/hrp_release) ⭐ 77 | 🐛 4 | 🌐 Python | 📅 2024-10-18
  * Mohan Kumar Srirama, Sudeep Dasari, Shikhar Bahl, Abhinav Gupta
...
* **OpenVLA: An Open-Source Vision-Language-Action Model**
  * [Code](https://github.com/openvla/openvla) ⭐ 6,826 | 🐛 114 | 🌐 Python | 📅 2025-03-23
...
* **Video Language Planning**
  * [Code](https://github.com/video-language-planning/vlp_code) ⭐ 83 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2025-05-23
...
* **Dreamitate: Real-World Visuomotor Policy Learning via Video Generation**
  * [Code](https://github.com/cvlab-columbia/dreamitate) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2025-06-07
...
* **Unleashing Large-Scale Video Generative Pre-training for Visual Robot Manipulation**
  * [Code](https://github.com/bytedance/GR-1) ⭐ 309 | 🐛 9 | 🌐 Python | 📅 2024-04-22
...
* **ManiWAV: Learning Robot Manipulation from In-the-Wild Audio-Visual Data**
  * [Code](https://github.com/real-stanford/maniwav) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2024-07-14
...
* **Learning to Act from Actionless Videos through Dense Correspondences**
  * [Code](https://github.com/flow-diffusion/AVDC) ⭐ 264 | 🐛 5 | 🌐 Python | 📅 2024-04-25
...
* **Track2Act: Predicting Point Tracks from Internet Videos Enables Diverse Zero-shot Manipulation**
  ...
  * [Code](https://github.com/homangab/Track-2-Act/) ⭐ 105 | 🐛 3 | 🌐 Python | 📅 2026-08-13

## Dataset

* **The Ingredients for Robotic Diffusion Transformers**
  * [Code](https://github.com/sudeepdasari/dit-policy) ⭐ 166 | 🐛 3 | 🌐 Python | 📅 2024-10-15
...
* **Beyond Sight: Finetuning Generalist Robot Policies with Heterogeneous Sensors via Language Grounding**
  * [Code](https://github.com/fuse-model/FuSe) ⭐ 71 | 🐛 2 | 🌐 Python | 📅 2025-09-18
...
* **Open X-Embodiment: Robotic Learning Datasets and RT-X Models**
  * [Code](https://github.com/google-deepmind/open_x_embodiment) ⭐ 1,981 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2025-11-05
...
* **BridgeData V2: A Dataset for Robot Learning at Scale**
  * [Code](https://github.com/rail-berkeley/bridge_data_v2) ⭐ 288 | 🐛 31 | 🌐 Python | 📅 2024-03-17
...
* **Ego4DSounds:A diverse egocentric dataset with high action-audio correspondence**
  * [Code](https://github.com/Ego4DSounds/Ego4DSounds) ⭐ 21 | 🐛 1 | 🌐 Python | 📅 2024-06-14
  * Changan Chen, Puyuan Peng, Ami Baid, Zihui Xue, Wei-Ning Hsu, David Harwath, Kristen Grauman
  * [Paper](https://arxiv.org/abs/2406.09272)
...
* **RH20T: A Comprehensive Robotic Dataset for Learning Diverse Skills in One-Shot**
  * [API](https://github.com/rh20t/rh20t_api) ⭐ 111 | 🐛 10 | 🌐 Python | 📅 2023-10-18
...
* [Awesome-LLMs-for-Video-Understanding](https://github.com/yunlong10/Awesome-LLMs-for-Video-Understanding) ⭐ 3,263 | 🐛 6 | 📅 2026-08-12
* [LLMs Meet Multimodal Generation and Editing: A Survey](https://github.com/YingqingHe/Awesome-LLMs-meet-Multimodal-Generation) ⭐ 551 | 🐛 1 | 🌐 HTML | 📅 2025-04-04
